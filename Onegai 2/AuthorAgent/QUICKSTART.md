...
3. Click **Go**
4. Watch the Activity Log tab as AuthorAgent plans and executes
...
3. Open your bot in Telegram and send:
   ...
   ```
4. AuthorAgent plans the steps and runs them, sending you updates
...
4. Restart AuthorAgent — premium skills appear with a star in the console
