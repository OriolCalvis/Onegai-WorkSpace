...
|---|---|---|---|
| **17/08 (Codex)** | Software raíz | Publicada GUIA_DE_COLABORACION.md: protocolo práctico para colaborar con agentes sin acceso directo al workspace mediante archivos, fragmentos, árbol de estructura o tareas asíncronas. Respeta canon -> cartas -> motor y remite a la bitácora. | 44a5029 |
